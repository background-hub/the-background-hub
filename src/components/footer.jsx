      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-80 items-center">
        ...
        <div className="text-start">
          ...
          <ul className="space-y-2">
            <li onClick={() => scrollToSection("about")} className="footer text-[20px]">
              {t("about.title")}
            </li>
            <li onClick={() => scrollToSection("services")} className="footer text-[20px]">
              {t("services.title")}
            </li>
          </ul>
        </div>
        ...
        <div className="flex flex-col flex-nowrap justify-center items-start">
          ...
          <div className="messageBox flex space-x-2">
            <input
              required
            ...
            />
            <button onClick={handleSendEmail} id="sendButton" className="bg-blue-600 text-white px-4 py-2 rounded-md">
