    ...
    <nav className="navbar p-4 h-27 flex flex-nowrap justify-center items-center flex-row">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex space-x-6 text-gray-800 dark:text-white text-2xl gap-6">
          ...
          <button className="font-semibold btn_nav" onClick={() => scrollToSection("about")}>
            {t("about.title")}
          </button>
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            >
                ...
                className={`absolute left-0 top-0 transition-opacity duration-300 ml-1 mr-0 mt-[3px] mb-0 ${darkMode ? "opacity-0" : "opacity-100"}`}
                >
                ...
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
                className={`absolute left-0 top-0 transition-opacity duration-300 ml-1 mr-0 mt-[3px] mb-0 ${darkMode ? "opacity-100" : "opacity-0"}`}
                >
